...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst21 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst20));
		...
		iConst52 = static_cast<int>(0.32f * fConst0);
		...
		iConst67 = static_cast<int>(0.5f * fConst0);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp12 = static_cast<float>(iRec13[0]);
			fVec2[0] = fTemp12;
			...
			fRec17[0] = fRec17[1] * static_cast<float>(1 - iTemp16) + 4.656613e-10f * fTemp12 * static_cast<float>(iTemp16);
			float fTemp17 = 0.5f * (fRec17[0] + 1.0f);
			fRec16[0] = ((std::fabs(4.656613e-10f * fVec2[1] * static_cast<float>((fRec18[0] >= fTemp17) * (fRec18[1] < fTemp17))) > 0.0f) ? std::fabs(fTemp13) : fRec16[1]);
			float fTemp18 = ((iTemp0) ? 0.0f : fRec15[1] + fConst26 * (1.2e+03f * fRec16[0] + 4e+02f));
			fRec15[0] = fTemp18 - std::floor(fTemp18);
			float fTemp19 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec15[0]), 65535))];
			fRec14[0] = fTemp19 - fConst24 * (fConst23 * fRec14[2] + fConst21 * fRec14[1]);
			float fTemp20 = 0.4f * (0.008f * (fTemp19 - fConst24 * (fRec14[2] + fRec14[0] + 2.0f * fRec14[1])) + fConst19 * (0.08f * fRec12[0] + 0.16f * fRec12[1] + 0.08f * fRec12[2]) + 0.025f * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec11[0]), 65535))] * (fTemp10 - fConst5 * (fRec5[2] + fRec5[0] + 2.0f * fRec5[1]) + (fTemp5 - fConst5 * (fRec0[2] + fRec0[0] + 2.0f * fRec0[1]))));
			...
			fRec24[0] = fRec24[1] * static_cast<float>(1 - iTemp23) + 4.656613e-10f * fTemp12 * static_cast<float>(iTemp23);
			float fTemp24 = 0.5f * (fRec24[0] + 1.0f);
			int iTemp25 = std::fabs(4.656613e-10f * fVec2[1] * static_cast<float>((fRec25[0] >= fTemp24) * (fRec25[1] < fTemp24))) > 0.0f;
			...
			float fTemp27 = std::max<float>(0.0f, std::min<float>(static_cast<float>(iRec26[0]), 1.0f) - fConst40 * static_cast<float>(iRec21[0]));
			...
			float fTemp33 = 18.0f * mydsp_faustpower2_f(std::min<float>(0.5f, fTemp27) - std::max<float>(0.5f, fTemp27));
			float fTemp34 = 1.0f / (14884.0f * mydsp_faustpower2_f(fTemp33 + (-1.0f - static_cast<float>(static_cast<int>(fTemp33 + -1.0f)))) + 1.0f);
			fRec27[0] = fTemp34 - (fRec27[2] * ((fTemp31 + -0.33333334f) / fTemp30 + 1.0f) + 2.0f * fRec27[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp30))) / fTemp32;
			...
			fRec29[0] = fTemp34 - (fRec29[2] * ((fTemp36 + -0.2f) / fTemp35 + 1.0f) + 2.0f * fRec29[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp35))) / fTemp37;
			...
			fRec31[0] = fTemp34 - (fRec31[2] * ((fTemp39 + -0.25f) / fTemp38 + 1.0f) + 2.0f * fRec31[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp38))) / fTemp40;
			...
			int iRec46 = iTemp44;
			int iRec47 = iTemp43;
			fRec33[0] = ((iTemp25) ? std::fabs(4.656613e-10f * static_cast<float>(iRec40)) : fRec33[1]);
			fRec48[0] = ((iTemp25) ? std::fabs(4.656613e-10f * static_cast<float>(iRec47)) : fRec48[1]);
			...
			fRec54[0] = fRec54[1] * static_cast<float>(1 - iTemp60) + 4.656613e-10f * fTemp12 * static_cast<float>(iTemp60);
			float fTemp61 = 0.5f * (fRec54[0] + 1.0f);
			int iTemp62 = std::fabs(4.656613e-10f * fVec2[1] * static_cast<float>((fRec55[0] >= fTemp61) * (fRec55[1] < fTemp61))) > 0.0f;
			...
			float fTemp64 = std::max<float>(0.0f, std::min<float>(static_cast<float>(iRec56[0]), 1.0f) - fConst45 * static_cast<float>(iRec51[0]));
			...
			float fTemp70 = 18.0f * mydsp_faustpower2_f(std::min<float>(0.5f, fTemp64) - std::max<float>(0.5f, fTemp64));
			float fTemp71 = 1.0f / (14884.0f * mydsp_faustpower2_f(fTemp70 + (-1.0f - static_cast<float>(static_cast<int>(fTemp70 + -1.0f)))) + 1.0f);
			fRec57[0] = fTemp71 - (fRec57[2] * ((fTemp68 + -0.33333334f) / fTemp67 + 1.0f) + 2.0f * fRec57[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp67))) / fTemp69;
			...
			fRec59[0] = fTemp71 - (fRec59[2] * ((fTemp73 + -0.2f) / fTemp72 + 1.0f) + 2.0f * fRec59[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp72))) / fTemp74;
			...
			fRec61[0] = fTemp71 - (fRec61[2] * ((fTemp76 + -0.25f) / fTemp75 + 1.0f) + 2.0f * fRec61[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp75))) / fTemp77;
			...
			fRec63[0] = ((iTemp62) ? std::fabs(4.656613e-10f * static_cast<float>(iRec39)) : fRec63[1]);
			fRec64[0] = ((iTemp62) ? std::fabs(4.656613e-10f * static_cast<float>(iRec46)) : fRec64[1]);
			...
			fRec70[0] = fRec70[1] * static_cast<float>(1 - iTemp84) + 4.656613e-10f * fTemp12 * static_cast<float>(iTemp84);
			float fTemp85 = 0.5f * (fRec70[0] + 1.0f);
			int iTemp86 = std::fabs(4.656613e-10f * fVec2[1] * static_cast<float>((fRec71[0] >= fTemp85) * (fRec71[1] < fTemp85))) > 0.0f;
			...
			float fTemp88 = std::max<float>(0.0f, std::min<float>(static_cast<float>(iRec72[0]), 1.0f) - fConst49 * static_cast<float>(iRec67[0]));
			...
			float fTemp94 = 18.0f * mydsp_faustpower2_f(std::min<float>(0.5f, fTemp88) - std::max<float>(0.5f, fTemp88));
			float fTemp95 = 1.0f / (14884.0f * mydsp_faustpower2_f(fTemp94 + (-1.0f - static_cast<float>(static_cast<int>(fTemp94 + -1.0f)))) + 1.0f);
			fRec73[0] = fTemp95 - (fRec73[2] * ((fTemp92 + -0.33333334f) / fTemp91 + 1.0f) + 2.0f * fRec73[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp91))) / fTemp93;
			...
			fRec75[0] = fTemp95 - (fRec75[2] * ((fTemp97 + -0.2f) / fTemp96 + 1.0f) + 2.0f * fRec75[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp96))) / fTemp98;
			...
			fRec77[0] = fTemp95 - (fRec77[2] * ((fTemp100 + -0.25f) / fTemp99 + 1.0f) + 2.0f * fRec77[1] * (1.0f - 1.0f / mydsp_faustpower2_f(fTemp99))) / fTemp101;
			...
			fRec79[0] = ((iTemp86) ? std::fabs(4.656613e-10f * static_cast<float>(iRec38)) : fRec79[1]);
			fRec80[0] = ((iTemp86) ? std::fabs(4.656613e-10f * static_cast<float>(iRec45)) : fRec80[1]);
			...
			float fTemp107 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec82[0]), 65535))] + ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec81[0]), 65535))];
			...
			fRec86[0] = fRec86[1] * static_cast<float>(1 - iTemp110) + 4.656613e-10f * fTemp12 * static_cast<float>(iTemp110);
			float fTemp111 = 0.5f * (fRec86[0] + 1.0f);
			int iTemp112 = std::fabs(4.656613e-10f * fVec2[1] * static_cast<float>((fRec87[0] >= fTemp111) * (fRec87[1] < fTemp111))) > 0.0f;
			...
			float fTemp115 = 44.0f * (fRec88[0] + (1.0f - (fRec83[0] + static_cast<float>(static_cast<int>(fRec88[0] + (1.0f - fRec83[0]))))));
			...
			float fTemp118 = std::max<float>(0.0f, std::min<float>(1.0f, std::sin(6.2831855f * (fTemp117 + fTemp116 - (static_cast<float>(static_cast<int>(fTemp117)) + static_cast<float>(static_cast<int>(fTemp116)))))));
			fRec89[0] = ((iTemp113 > 0) ? fConst56 : std::max<float>(0.0f, fRec89[1] + -1.0f));
			float fTemp119 = static_cast<float>(fRec89[0] > 0.0f);
			fRec91[0] = ((iTemp112) ? std::fabs(4.656613e-10f * static_cast<float>(iRec37)) : fRec91[1]);
			fRec92[0] = ((iTemp112) ? std::fabs(4.656613e-10f * static_cast<float>(iRec44)) : fRec92[1]);
			...
			float fTemp123 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec94[0]), 65535))] + ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec93[0]), 65535))];
			...
			fRec97[0] = fRec97[1] * static_cast<float>(1 - iTemp126) + 4.656613e-10f * fTemp12 * static_cast<float>(iTemp126);
			float fTemp127 = 0.5f * (fRec97[0] + 1.0f);
			int iTemp128 = std::fabs(4.656613e-10f * fVec2[1] * static_cast<float>((fRec98[0] >= fTemp127) * (fRec98[1] < fTemp127))) > 0.0f;
			...
			float fTemp130 = 44.0f * (fRec88[0] + (1.0f - (fRec95[0] + static_cast<float>(static_cast<int>(fRec88[0] + (1.0f - fRec95[0]))))));
			...
			float fTemp133 = std::max<float>(0.0f, std::min<float>(1.0f, std::sin(6.2831855f * (fTemp132 + fTemp131 - (static_cast<float>(static_cast<int>(fTemp132)) + static_cast<float>(static_cast<int>(fTemp131)))))));
			fRec99[0] = ((iTemp129 > 0) ? fConst56 : std::max<float>(0.0f, fRec99[1] + -1.0f));
			float fTemp134 = static_cast<float>(fRec99[0] > 0.0f);
			fRec101[0] = ((iTemp128) ? std::fabs(4.656613e-10f * static_cast<float>(iRec36)) : fRec101[1]);
			fRec102[0] = ((iTemp128) ? std::fabs(4.656613e-10f * static_cast<float>(iRec43)) : fRec102[1]);
			...
			float fTemp138 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec104[0]), 65535))] + ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec103[0]), 65535))];
			...
			fRec107[0] = fRec107[1] * static_cast<float>(1 - iTemp141) + 4.656613e-10f * fTemp12 * static_cast<float>(iTemp141);
			float fTemp142 = 0.5f * (fRec107[0] + 1.0f);
			int iTemp143 = std::fabs(4.656613e-10f * fVec2[1] * static_cast<float>((fRec108[0] >= fTemp142) * (fRec108[1] < fTemp142))) > 0.0f;
			...
			float fTemp145 = 44.0f * (fRec88[0] + (1.0f - (fRec105[0] + static_cast<float>(static_cast<int>(fRec88[0] + (1.0f - fRec105[0]))))));
			...
			float fTemp148 = std::max<float>(0.0f, std::min<float>(1.0f, std::sin(6.2831855f * (fTemp147 + fTemp146 - (static_cast<float>(static_cast<int>(fTemp147)) + static_cast<float>(static_cast<int>(fTemp146)))))));
			fRec109[0] = ((iTemp144 > 0) ? fConst56 : std::max<float>(0.0f, fRec109[1] + -1.0f));
			float fTemp149 = static_cast<float>(fRec109[0] > 0.0f);
			fRec111[0] = ((iTemp143) ? std::fabs(4.656613e-10f * static_cast<float>(iRec35)) : fRec111[1]);
			fRec112[0] = ((iTemp143) ? std::fabs(4.656613e-10f * static_cast<float>(iRec42)) : fRec112[1]);
			...
			float fTemp153 = ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec114[0]), 65535))] + ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec113[0]), 65535))];
			...
			fRec118[0] = fRec118[1] * static_cast<float>(1 - iTemp156) + 4.656613e-10f * fTemp12 * static_cast<float>(iTemp156);
			float fTemp157 = 0.5f * (fRec118[0] + 1.0f);
			int iTemp158 = std::fabs(4.656613e-10f * fVec2[1] * static_cast<float>((fRec119[0] >= fTemp157) * (fRec119[1] < fTemp157))) > 0.0f;
			...
			float fTemp160 = 44.0f * (fRec88[0] + (1.0f - (fRec115[0] + static_cast<float>(static_cast<int>(fRec88[0] + (1.0f - fRec115[0]))))));
			...
			float fTemp163 = std::max<float>(0.0f, std::min<float>(1.0f, std::sin(6.2831855f * (fTemp162 + fTemp161 - (static_cast<float>(static_cast<int>(fTemp162)) + static_cast<float>(static_cast<int>(fTemp161)))))));
			fRec120[0] = ((iTemp159 > 0) ? fConst56 : std::max<float>(0.0f, fRec120[1] + -1.0f));
			float fTemp164 = static_cast<float>(fRec120[0] > 0.0f);
			fRec122[0] = ((iTemp158) ? std::fabs(4.656613e-10f * static_cast<float>(iRec34[0])) : fRec122[1]);
			fRec123[0] = ((iTemp158) ? std::fabs(4.656613e-10f * static_cast<float>(iRec41)) : fRec123[1]);
			...
			fRec131[0] = static_cast<float>(iTemp0) + fConst71 * fRec131[1] - fConst72 * fRec130[1];
			int iTemp166 = (fRec130[1] <= 0.0f) & (fRec130[0] > 0.0f);
			fRec129[0] = fRec129[1] * static_cast<float>(1 - iTemp166) + 4.656613e-10f * fTemp12 * static_cast<float>(iTemp166);
			...
			output0[i0] = static_cast<FAUSTFLOAT>(0.3f * fRec124[0] * (fRec121[0] * fTemp164 * fTemp163 * fTemp153 + fRec110[0] * fTemp149 * fTemp148 * fTemp138 + fRec100[0] * fTemp134 * fTemp133 * fTemp123 + fRec90[0] * fTemp119 * fTemp118 * fTemp107) + 0.5f * (fRec78[0] * fTemp103 + fRec62[0] * fTemp79 + fRec32[0] * fTemp42) + fTemp20);
			...
			output1[i0] = static_cast<FAUSTFLOAT>(0.5f * (fRec138[0] * fTemp103 + fRec137[0] * fTemp79 + fRec136[0] * fTemp42) + fTemp20 + 0.3f * fRec124[0] * (fRec135[0] * fTemp164 * fTemp163 * fTemp153 + fRec134[0] * fTemp149 * fTemp148 * fTemp138 + fRec133[0] * fTemp134 * fTemp133 * fTemp123 + fRec132[0] * fTemp119 * fTemp118 * fTemp107));
			iVec0[1] = iVec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];

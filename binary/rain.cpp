...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		iConst36 = static_cast<int>(std::min<float>(3e+02f, std::max<float>(0.0f, 0.0037f * fConst0)));
		...
		fConst48 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst47));
		...
		iConst53 = static_cast<int>(std::min<float>(3e+02f, std::max<float>(0.0f, 0.0042f * fConst0)));
		fConst54 = 1.0f / (fConst47 * fConst51);
		fConst55 = 443.0f / fConst0;
		fConst56 = std::tan(6239.203f / fConst0);
		fConst57 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst56));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec2[0] = 4.656613e-10f * static_cast<float>(iRec3[0]) - fConst9 * (fConst7 * fRec2[2] + fConst5 * fRec2[1]);
			float fTemp0 = mydsp_faustpower4_f(std::max<float>(0.05f, std::max<float>(0.0f, std::min<float>(1.0f, fConst10 * (fRec2[0] - fRec2[2])))) + -0.05f);
			fVec1[0] = fTemp0;
			...
			int iRec27 = iTemp4;
			int iRec28 = iTemp3;
			fRec18[0] = 2.550532e-10f * (static_cast<float>(iRec28) + static_cast<float>(iRec27) + static_cast<float>(iRec26) + static_cast<float>(iRec25) + static_cast<float>(iRec24) + static_cast<float>(iRec23) + static_cast<float>(iRec22) + static_cast<float>(iRec21) + static_cast<float>(iRec20) + static_cast<float>(iRec19[0])) - fConst28 * (fConst26 * fRec18[2] + fConst24 * fRec18[1]);
			...
			float fTemp14 = std::max<float>(0.35f, 1e+01f * mydsp_faustpower2_f(fRec17[0]) * std::cos(6.2831855f * (fRec16[0] + -0.25f))) + -0.35f;
			fVec4[0] = fTemp14;
			...
			fRec7[0] = fConst37 * (fRec12[0] - fRec12[2]) * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec11[0]), 65535))];
			...
			float fRec8 = fConst45 * (fRec30[0] - fRec30[2]) * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec29[0]), 65535))];
			float fRec9 = fTemp16;
			fRec4[0] = fRec8;
			...
			fRec31[0] = fConst54 * (fRec35[0] - fRec35[2]) * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec34[0]), 65535))];
			...
			float fRec32 = fConst62 * (fRec37[0] - fRec37[2]) * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec36[0]), 65535))];
			float fRec33 = fTemp19;
			fRec5[0] = fRec32;
			float fRec6 = fRec9 + fRec33;
			float fTemp21 = fRec6 + fRec1[0];
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp21 * fRec0[0]);
			fRec38[0] = 0.9999f * fRec38[1] + 4.472136e-05f;
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp21 * fRec38[0]);
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			iRec3[1] = iRec3[0];
			fRec2[2] = fRec2[1];
